...
public class BookContentIndexService : IDisposable
{
    ...
    public async Task IndexBookContent(string bookId, List<EpubContent> htmlContents)
    {
    ...
    public List<SearchResult> Search(string bookId, string queryText, int maxResults = 10)
    {
        ...
        foreach (var hit in hits)
        {
            ...
            var tokenStream1 = _analyzer.GetTokenStream("content", content);
            ...
            var tokenStream2 = _analyzer.GetTokenStream("content", content);
